...
function exportCSV() {
  ...
  download(`prakritisense_${state.participantId}_${Date.now()}.csv`, csv, "text/csv");
}
...
function exportJSON() {
  ...
  download(`prakritisense_${state.participantId}_${Date.now()}.json`, data, "application/json");
}
